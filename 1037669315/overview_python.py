...
predefined function
## `isinistance`:
Dos argumentos: la variable que se quiere revisar y el tipo de variable por el que se va a preguntar
"""
...
#el signo de admiracion sirve para crear un bloque como si fuera la terminal.
! chmod a+x print.py
...
hello='Hello World!' #Anteceder el string con una f para usar las variables
print(f'{hello} cruel')
...
x=23456.5678545 #Poner .2f para imprimir el numero de decimales
print(f'{x:.2f}')
